...
#define EXT_STR_h101_MOSAIC_ITEMS_INFO(ok,si,offset,struct_t,printerr) do { \
  ok = 1; \
  /* RAW */ \
  ...
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     MOSAIC1TRIG_SYNC,                UINT32,\
                    "MOSAIC1TRIG_SYNC",65535,0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     MOSAIC1CHIP,                     UINT32,\
  ...
  EXT_STR_ITEM_INFO2    (ok,si,offset,struct_t,printerr,\
                    ...
                    "MOSAIC2T_LO",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     MOSAIC2TRIG_SYNC,                UINT32,\
                    "MOSAIC2TRIG_SYNC",65535,0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     MOSAIC2CHIP,                     UINT32,\
  ...
  EXT_STR_ITEM_INFO2    (ok,si,offset,struct_t,printerr,\
                    ...
                    "MOSAIC3T_LO",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     MOSAIC3TRIG_SYNC,                UINT32,\
                    "MOSAIC3TRIG_SYNC",65535,0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     MOSAIC3CHIP,                     UINT32,\
  ...
  EXT_STR_ITEM_INFO2    (ok,si,offset,struct_t,printerr,\
                    ...
                    "MOSAIC4T_LO",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     MOSAIC4TRIG_SYNC,                UINT32,\
                    "MOSAIC4TRIG_SYNC",65535,0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     MOSAIC4CHIP,                     UINT32,\
  ...
  EXT_STR_ITEM_INFO2    (ok,si,offset,struct_t,printerr,\
                    ...
                    "MOSAIC5T_LO",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     MOSAIC5TRIG_SYNC,                UINT32,\
                    "MOSAIC5TRIG_SYNC",65535,0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     MOSAIC5CHIP,                     UINT32,\
  ...
  EXT_STR_ITEM_INFO2    (ok,si,offset,struct_t,printerr,\
                    ...
                    "MOSAIC6T_LO",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     MOSAIC6TRIG_SYNC,                UINT32,\
                    "MOSAIC6TRIG_SYNC",65535,0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     MOSAIC6CHIP,                     UINT32,\
  ...
  EXT_STR_ITEM_INFO2    (ok,si,offset,struct_t,printerr,\
                    ...
                    "MOSAIC7T_LO",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     MOSAIC7TRIG_SYNC,                UINT32,\
                    "MOSAIC7TRIG_SYNC",65535,0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     MOSAIC7CHIP,                     UINT32,\
  ...
  EXT_STR_ITEM_INFO2    (ok,si,offset,struct_t,printerr,\
                    ...
                    "MOSAIC8T_LO",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     MOSAIC8TRIG_SYNC,                UINT32,\
                    "MOSAIC8TRIG_SYNC",65535,0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     MOSAIC8CHIP,                     UINT32,\
  ...
  EXT_STR_ITEM_INFO2    (ok,si,offset,struct_t,printerr,\
                    ...
                    "MOSAIC9T_LO",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     MOSAIC9TRIG_SYNC,                UINT32,\
                    "MOSAIC9TRIG_SYNC",65535,0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     MOSAIC9CHIP,                     UINT32,\
