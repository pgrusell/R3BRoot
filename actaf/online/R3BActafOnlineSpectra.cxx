...
InitStatus R3BActafOnlineSpectra::Init()
{
    ...
    if (fClusterItems != nullptr)
    {
        ...
        cClusterUp->cd(6);
        fh2_XYPos_clusters.push_back(R3B::root_owned<TH2Poly>(fh2_XYPos[0]->Clone((fh2_XYPos[0]->GetTitle() + TString("_clusters)")).Data()));
        ...
        fh2_XYPos_clusters.push_back(R3B::root_owned<TH2Poly>(fh2_XYPos[1]->Clone((fh2_XYPos[1]->GetTitle() + TString("_clusters)")).Data()));
